...
* **[Application Programming Interface](docs/05_api_reference/index.md)**
    ...
    * [Data Structures](docs/05_api_reference/5_3_data_structures.md)
        - [*Device information*](docs/05_api_reference/5_3_data_structures.md#device-information)
        - [*Time tag data*](docs/05_api_reference/5_3_data_structures.md#time-tag-data)
        - [*Count rate (CPS) data*](docs/05_api_reference/5_3_data_structures.md#count-rate-data)
        - [*Time Interval Histogram (TIHI) data*](docs/05_api_reference/5_3_data_structures.md#time-travel-histogram-data)
        - [*Multi-Fold Coincidence (MFCO) data*](docs/05_api_reference/5_3_data_structures.md#multi-fold-coincidence-data)
        - [*Linear Correlation (CORL) data*](docs/05_api_reference/5_3_data_structures.md#linear-correlation-data)
        - [*Multi-Tau Correlation (CORM) data*](docs/05_api_reference/5_3_data_structures.md#multi-tau-correlation-data)
        - [*Telemetry data*](docs/05_api_reference/5_3_data_structures.md#telemetry-data)
        - [*Field update structures*](docs/05_api_reference/5_3_data_structures.md#field-update-structures)
        - [*Configuration dump*](docs/05_api_reference/5_3_data_structures.md#configuration-dump)
    * [Callback Types](docs/05_api_reference/5_4_callback_types.md)
        - [*Data callbacks*](docs/05_api_reference/5_4_callback_types.md#callback-types)
        - [*Event callbacks*](docs/05_api_reference/5_4_callback_types.md#event-callbacks)
    * [Measurement Modules](docs/05_api_reference/5_5_measurement_modules.md)
        - [*Time Interval Histogram (TIHI) advanced config*](docs/05_api_reference/5_5_measurement_modules.md#time-interval-histogram-config)
        - [*Multi-Fold Coincidence (MFCO) advanced config*](docs/05_api_reference/5_5_measurement_modules.md#multi-fold-coincidence-config)
        - [*Intensity Correlation (CORL / CORM)*](docs/05_api_reference/5_5_measurement_modules.md#intensity-correlation)
        - [*Dynamic Light Scattering (DLS) analysis*](docs/05_api_reference/5_5_measurement_modules.md#dynamic-light-scattering-analysis)
        - [*Fluorescence Correlation Spectroscopy (FCS)*](docs/05_api_reference/5_5_measurement_modules.md#fluorescence-correlation-spectroscopy)
        - [*Diffuse Correlation Spectroscopy (DCS)*](docs/05_api_reference/5_5_measurement_modules.md#diffuse-correlation-spectroscopy)
    * [MFCO Pattern Analysis Helpers](docs/05_api_reference/5_6_mfco_pattern_analysis_helpers.md)
* **[In-Depth Guides](docs/06_in_depth_guides/index.md)**
    ...
    * [Curve Fitting and Analysis Pipelines](docs/06_in_depth_guides/6_4_curve_fitting_and_analysis_pipelines.md)
        - [*TIHI lifetime fitting models*](docs/06_in_depth_guides/6_4_curve_fitting_and_analysis_pipelines.md#tihi-lifetime-fitting-models)
        - [*Correlation fitting (Multi-Tau CORM)*](docs/06_in_depth_guides/6_4_curve_fitting_and_analysis_pipelines.md#correlation-fitting)
        - [*Dynamic Light Scattering (DLS) analysis*](docs/06_in_depth_guides/6_4_curve_fitting_and_analysis_pipelines.md#dynamic-light-scattering-analysis)
