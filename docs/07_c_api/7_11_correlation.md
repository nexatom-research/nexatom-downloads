...
| `nexatom_tt_set_intensity_correlation_num_bins`| `[In] nexatom_tt_handle device`<br>`[In] uint32_t num_bins` | `nexatom_error_code_t` | Configures the number of computed lags (valid range: 1000–65535). |
